...
import com.github.numq.composesplitscreen.VerticalSplitScreen
...
fun main() = singleWindowApplication(title = "Split Screen") {
    Row(
        ...
        HorizontalSplitScreen(modifier = Modifier.weight(1f), left = { dp ->
            Box(
        ...
        VerticalSplitScreen(modifier = Modifier.weight(1f), top = { dp ->
            Box(
